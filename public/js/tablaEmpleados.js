            ...
            .then(employees => {
                ...
                if (employees.length > 0) {
                    employees.forEach(employee => {
                        ...
                        <td>
                        <a href="index.php?controller=EmployeeController&action=edit&id=${employee.id}" class="btn btn-primary">Editar</a>
                        <a href="index.php?controller=EmployeeController&action=inactivate&id=${employee.id}" class="btn btn-warning">Inactivar</a>
                        </td>
                    `;
